...
export interface JsonGeneratorNavBarProps {
    
}
 
export interface JsonGeneratorNavBarState {
    
}
 
class JsonGeneratorNavBar extends React.Component<JsonGeneratorNavBarProps, JsonGeneratorNavBarState> {
    constructor(props: JsonGeneratorNavBarProps) {
        super(props);
        this.state = {  };
    }
    toggleOffcanvas() {
...
export default JsonGeneratorNavBar;