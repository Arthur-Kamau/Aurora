...
export interface ForgotPasswordKeyPageProps {

}

export interface ForgotPasswordKeyPageState {

}

class ForgotPasswordKeyPage extends React.Component<ForgotPasswordKeyPageProps, ForgotPasswordKeyPageState> {
    constructor(props: ForgotPasswordKeyPageProps) {
        super(props);
        this.state = {};
    }
    render() {
